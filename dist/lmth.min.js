...
return r.children=i,r},e.prototype.render=function(){var e=this,t=Object.keys(e.attributes).reduce(function(t,n){return t+" "+c(n,e.attributes[n])},""),n=a(e.content)+e.children.reduce(function(e,t){return e+(i(t)?a(t):t.render())},"")
...
return Object.keys(t.attributes).forEach(function(e){var r=t.attributes[e],i=l(e)
