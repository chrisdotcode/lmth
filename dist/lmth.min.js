...
i&&r===!0?n.setAttribute(e,e):i&&r===!1||n.setAttribute(e,r)}),t.id&&(n.id=t.id),t["class"].length>0&&(n.className=t["class"].join(" ")),t.style&&n.setAttribute("style",u(t.style)),t.listeners&&Object.keys(t.listeners).forEach(function(e){t.listeners[e].forEach(function(t){n.addEventListener(e,t)})}),null!=t.content&&n.appendChild(e.createTextNode(t.content)),t.children.forEach(function(r){n.appendChild(i(r)?e.createTextNode(r):t.toDOM(e))}),n},e.appendListToDOM=function(e,t,n){t.forEach(function(t){e.appendChild(t.toDOM(n))})},e})
