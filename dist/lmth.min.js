...
return this.name=t,this.isVoid=n,this.id=r,this["class"]=i,this.style=o,this.listeners=s,this.attributes=a,this.content=c,this.children=l.reduce(function(e,t){return e.concat(t)},[]),this}function t(e){var t=typeof e
return"bool"===t||"number"===t||"string"===t}function n(e){return"[object Object]"===toString.call(e)}function r(e){return t(e)?"primitive":n(e)?"object":Array.isArray(e)?"array":void 0}function i(e){return"[object String]"===toString.call(e)}function o(e,t,n){var r=n[e]
r?r.push(t):n[e]=[].concat(t)}function s(e){var t={id:null,"class":[],style:null,listeners:{}}
...
n.startsWith("on")&&("function"==typeof r||Array.isArray(r))?o(n.slice(2),r,t.listeners):t[n]=r}),i(t["class"])?t["class"]=t["class"].split(" "):Array.isArray(t["class"])||(t["class"]=[t["class"]]))
return t}function a(e){return String(e).replace(/&|<|>|"|'/g,function(e){return"&"===e?"&amp;":"<"===e?"&lt;":">"===e?"&gt;":'"'===e?"&quot;":"'"===e?"&apos;":void 0})}function c(e){return/^(?:allowfullscreen|async|autofocus|autoplay|checked|compact|controls|declare|default|defaultchecked|defaultmuted|defaultselected|defer|disabled|draggable|enabled|formnovalidate|hidden|indeterminate|inert|ismap|itemscope|loop|multiple|muted|nohref|noresize|noshade|novalidate|nowrap|open|pauseonexit|readonly|required|reversed|scoped|seamless|selected|sortable|spellcheck|translate|truespeed|typemustmatch|visible)$/i.test(e)}function l(e,t){var n=c(e)
return n&&t===!0?e+'="'+e+'"':n&&t===!1?"":e+'="'+a(t)+'"'}function u(e){return Object.keys(e).reduce(function(t,n){return t+n+":"+e[n]+";"},"")}return e.prototype.toString=function(){return JSON.stringify(this)},e["new"]=function(t,n,r,i,o,s,a,c,l){return new e(t,n,r,i,o,s,a,c,l)},e.createElement=function(t,n){var o=n.isVoid||!1
